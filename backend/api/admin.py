...
class CustomUserAdmin(UserAdmin):
    fieldsets = UserAdmin.fieldsets + (
        ('Custom Fields', {'fields': ('role', 'is_privacy_notice_accepted', 'privacy_acceptance_ip', 'privacy_acceptance_timestamp')}),
    )
    add_fieldsets = UserAdmin.add_fieldsets + (
        ('Custom Fields', {'fields': ('role', 'is_privacy_notice_accepted')}),
    )
    readonly_fields = ('privacy_acceptance_ip', 'privacy_acceptance_timestamp')
...
class AttachmentAdmin(admin.ModelAdmin):
    list_display = ('application', 'question_key', 'file', 'uploaded_at')
    list_filter = ('application',)
